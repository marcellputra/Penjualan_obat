...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 01 Okt 2024 pada 04.18
...
ALTER TABLE `cart`
  ...
  ADD CONSTRAINT `cart_ibfk_2` FOREIGN KEY (`id_produk`) REFERENCES `produk` (`id_obat`) ON DELETE CASCADE;
...
ALTER TABLE `detail_transaksi`
  ...
  ADD CONSTRAINT `detail_transaksi_ibfk_2` FOREIGN KEY (`id_produk`) REFERENCES `produk` (`id_obat`) ON DELETE CASCADE;
...
--
ALTER TABLE `user`
  ADD CONSTRAINT `user_ibfk_1` FOREIGN KEY (`id_akun`) REFERENCES `akun` (`id_akun`) ON DELETE CASCADE;
COMMIT;
